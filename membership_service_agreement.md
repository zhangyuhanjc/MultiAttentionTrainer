...
在适用法律允许的最大范围内，开发者本人明确表示不提供任何其他类型的保证，不论使明示的或默示的，包括但不限于适销性、适用性、可靠性、准确性、完整性、无病毒以及无错误的任何默示保证和责任。

在适用法律允许的最大范围内，开发者本人及其许可人不会向您做出以下声明或担保:
1. 您对服务的使用会满足您的需求
2. 您对服务的使用会连续无中断、及时、安全或没有错误；
3. 您使用相关服务而获得的任何信息一律准确可靠；
4. 作为相关服务的一部分向您提供的任何软件所发生的操作或功能瑕疵将获得修正。

在适用法律允许的最大范围内，开发者本人不因您使用本应用引起的，或在任何方面与开发者本人的产品和服务有关的任何意外的、非直接的、特殊的、或间接的损害或请求（包括但不限于因人身伤害、因隐私泄漏、因未能履行包括诚信或合理谨慎在内的任何责任、因过失和因任何其他金钱上的损失或其他损失而造成的损害赔偿）承担任何责任。

## 不可抗力条款

开发者本人对不可抗力导致的损失不承担责任。本服务条款所指不可抗力包括：天灾、法律法规或政府指令的变更，因网络服务特性而特有的原因，例如境内外基础电信运营商的故障、计算机或互联网相关技术缺陷、互联网覆盖范围限制、计算机病毒、黑客攻击等因素，及其他合法范围内的不能预见、不能避免并不能克服的客观情况。

## 通知

所有发给您的通知都可通过您电子邮件、或在网站显著位置公告的方式进行传送。开发者本人将通过上述方法之一将消息传递给您，告知其服务条款的修改、服务变更、或其它重要事情。同时，开发者本人保留在本应用中投放商业性广告的权利以及利用您登录的邮箱发布商业性广告的权利，包括但不限于在邮箱的登录页面及登录后任何页面内放置商业广告、向邮箱的您发送商业性广告邮件以及在邮箱的您发出的电子邮件内附上商业性广告及／或广告链接等形式，但您有权在邮箱内的广告邮件内选择拒绝接受此类广告等信息。

## 保障

您同意保障和维护开发者本人的利益，负责支付由您或您创建的组织成员违反本服务条款和/或其他服务条款引起的律师费用、损害补偿费用、政府机关处罚费用和其它侵权赔偿费用等。

## 终止

您可自行决定随时终止本协议，但除本条款另有约定外，您将无权要求开发者本人退还截至该终止日期时已支付费用或者减免您应付费用。

鉴于网络服务的特殊性，如果您是免费用户，开发者本人保留随时变更、中断或终止服务而不需通知您的权利。您确认并接受开发者本人行使变更、中断或终止服务的权利，开发者本人不需对您或第三方负责。

如果您是付费用户，本应用可以通过您在注册时提供的联系信息，经提前三十(30)天向您发出书面通知后终止本服务条款，并会按比例退还截至终止生效日期时未消费的任何预付费用。

如果一方违反本服务条款的重要约定，并在非违约方提出该等违约的书面通知的十 (10) 天内未能予以纠正，则另一方可终止本服务条款。例外情况是，如果您实质性违反其在第 5、6、7、8 条项下的义务，则开发者本人有权未经通知立即对您终止本服务。

如果您因开发者本人违约而终止本服务条款，则您获得的唯一且排他性的救济以及开发者本人对该等违约的全部责任将是退还由您根据本服务条款向开发者本人支付的费用。

## 法律

上述条款是各方针对本文主题的全部协议，优先于并取代所有以前或同期对此类主题的书面或口头的规定或协议。对上述任何条款的排除必须采取书面形式，并得到开发者本人提供或通过本应用提供其软件的第三方书面签字，才能生效。

您只有无条件接受本服务条款，才能继续使用本服务。如您对本服务条款内容有任何疑问或进行任何投诉，可发邮件至 hcx_66714040@126.com。
